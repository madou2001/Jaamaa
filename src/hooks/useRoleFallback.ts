  ...
  useEffect(() => {
    const fetchUserRole = async () => {
      ...
      try {
        ...
        if (error) {
          // Fallback: utiliser la logique basée sur l'email et l'ID
          ...
          const userProfile: UserProfile = {
            ...
            full_name: profile.full_name || profile.first_name + ' ' + profile.last_name || user.email?.split('@')[0] || '',
